                            ...
                            <div class="card bg-light mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" placeholder="" id="notesRecipient" rows="3"
                                                cols="20" name="notesRecipient" readonly></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" placeholder=""
                                                id="streetLine1Recipient" name="streetLine1Recipient" value="" required>
                                ...
                                <div class="card bg-light mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" placeholder=""
                                                    id="numberOfPieces" name="numberOfPieces" value="" required>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" placeholder="" id="weightUnits"
                                                    name="weightUnits" value="KG" required>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-floating mb-3">
                                                                            <input type="text" class="typeaheadShipperOrigin form-control"
